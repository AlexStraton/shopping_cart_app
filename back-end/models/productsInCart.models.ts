...
return db.query(
  "INSERT INTO productsInCart (product_id, user_id, quantity) VALUES ($1, $2, $3) RETURNING *;", [product_id, user_id, quantity]
)
}

const removeProductFromCart = (cart_line_id: string) => {
  return db.query("DELETE FROM productsInCart WHERE cart_line_id = $1", [cart_line_id])
}
...
export { fetchAllProductsInCart, addProductToCart, removeProductFromCart, updateProductInCart };
